        ...
        <div class="col-12 col-md-6 col-lg-6 order-sm-1 order-md-2">
            <form style="text-align: center;" class="form-inline my-2 my-lg=0" type="get" action="{{ route('searchFaculty') }}">
                ...
                <div class="input-group">
                    <input type="search" name="searchFaculty" class="form-control mr-sm2" placeholder="Search Faculy Account Name">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="align-middle">
                    <button type="button" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#ModalEditUser{{ $user->id }}"><i class='bx bxs-edit'></i></button>
                    <button type="button" class="btn btn-outline-danger" data-bs-toggle="modal" data-bs-target="#ModalDeleteUser{{ $user->id }}"> <i class='bx bx-trash'></i></button>
                </td>
            </tr>
            <!-- Edit User Modal-->
                    ...
                    <div class="modal-dialog modal-dialog-centered modUal-dialog-scrollable modal-lg">
                        <div class="modal-content  bg-light">
                            ...
                            <div class="modal-header border-0 text-center">
                                <h5 class="modal-title  text-center">Faculty Account Details</h5>
                                ...
                                <div class="container-fluid">
                                    <div class="row g-4 m-4 p-0 d-flex align-items-stretch g-l">
                                        ...
                                        <div class="modal-footer border-0">
                                            ...
                                            <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#ModalEditPass{{ $user->id }}">
            ...
            <form action="{{ route('resetPasswordFaculty', $user->id) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="modal-body">
                                <div class="container-fluid">
                                    <div class="row g-4 m-4 p-0 d-flex align-items-stretch g-l">
                                        ...
                                        <div class="col-12">
                                            <label for="formGroupExampleInput" class="form-label">Default Password</label>
                                            <input id="password" type="input" class="form-control" name="password" required autocomplete="new-password">
                                        </div>

                                        <div class="col-12">
                                            <label for="formGroupExampleInput" class="form-label">Confirm Password</label>
                                            <input id="password_confirmation" type="input" class="form-control" name="password_confirmation" required>
                                        </div>
...
<!-- Add User Modal-->
<form action="{{ route('storeUserFaculty') }}" method="post" enctype="multipart/form-data">
    @csrf
    <div class="modal fade" id="ModalAddUser" tabindex="-1" aria-labelledby="ModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
            <div class="modal-content">
                <div class="modal-header border-0 text-center">
                    <h5 class="modal-title  text-center">Add Faculty Account</h5>
                    <button type="button" class="btn-close btn-info bg-info" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="container-fluid">
                        <div class="row g-4 m-4 p-0 d-flex align-items-stretch g-l">
                            ...
                            <div class="col-12 col-md-4 col-lg-4">
                                ...
                                <input type="input" placeholder="Enter Last Name" class="form-control" name="last_name" required>
                            </div>
                            ...
                            <div class="col-12">
                                <label for="formGroupExampleInput" class="form-label">Educational
                                    Attaintment</label>
                                <input type="input" placeholder="Enter Educational Attaintment" class="form-control" name="educational" required>
                            </div>

                            <div class="col-12 col-md-6">
                                <label for="formGroupExampleInput" class="form-label">Rank</label>
                                <input type="input" placeholder="Enter Rank" class="form-control" name="rank" required>
                            </div>

                            <div class="col-12 col-md-6">
                                <label for="formGroupExampleInput" class="form-label">Specialty</label>
                                <input type="input" placeholder="Enter Specialty" class="form-control" name="specialty" required>
                            </div>

                            <div class="col-12 col-md-6">
                                <label for="formGroupExampleInput" class="form-label">Phone Number</label>
                                <input type="input" placeholder="Enter Phone Number" class="form-control" name="phone_no" required>
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <input type="input" name="password" class="form-control" placeholder="Enter Password" required>
                            </div>
