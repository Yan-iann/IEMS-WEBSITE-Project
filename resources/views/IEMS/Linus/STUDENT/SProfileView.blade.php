...
<div class="container-fluid" style="height: 100%">
            ...
            <div class="col-12 col-lg-8">
                <div class="row g-1">
                    ...
                    <div class="col-12 d-flex jsutify-content-end">
                        <button type="button" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#ModalEditProf{{ $item->id }}">
                            <i class='bx bxs-edit'></i>
                            Edit Profile
                        </button>

                        <button type="button" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#ModalEditPass{{ $item->id }}">
                            <i class='bx bxs-edit'> </i>
                            Change Password
                        </button>
                    </div>
    ...
    <form action="{{ route('editSprofile', $item->id) }}" method="post" enctype="multipart/form-data">
        <div class="modal fade" id="ModalEditProf{{ $item->id }}" tabindex="-1" aria-labelledby="ModalLabel" aria-hidden="true">
            {!! csrf_field() !!}
                        ...
                        <div class="container-fluid">
                            <div class="row g-4 m-4 p-0 d-flex align-items-stretch g-l">
                                ...
                                <div class="col-12 ">
                                    ...
                                    <input type="input" class="form-control" name="email" value="{{ $item->email }}" readonly>
                                </div>
    ...
    <form action="{{ route('updatePassStudent', $item->id) }}" method="post" enctype="multipart/form-data">
        ...
        <div class="modal fade" id="ModalEditPass{{ $item->id }}" tabindex="-1" aria-labelledby="ModalLabel" aria-hidden="true">
            {!! csrf_field() !!}
            <div class="modal-dialog modal-dialog-centered modUal-dialog-scrollable modal-lg">
                <div class="modal-content  bg-light">
