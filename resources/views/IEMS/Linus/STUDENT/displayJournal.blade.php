{{-- Jounral Article Information Card --}}
  ...
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
    <div class="modal-content bg-light">
      ...
      <div class="modal-footer border-0">
        <button type="button" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#Notify{{$item->info_ID}}">View</button>
      </div>
    </div>
...
<div class="modal fade" id="Notify{{$item->info_ID}}" tabindex="-1" aria-labelledby="ModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable ">
      <div class="modal-content bg-light">
        ...
        <div class="modal-footer border-0">
          <button type="button" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#ModalJournal{{$item->info_ID}}">Okay</button>
        </div>
      </div>
    </div>
  </div>
