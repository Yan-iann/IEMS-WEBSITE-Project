    ...
    padding-bottom: 180px; min-height:85vh"
            ...
            <div class="container">
                <div class="row d-flex justify-content-between align-items-center">
                    ...
                    <div class="col-12 col-md-6 order-sm-1 order-md-2 order-lg-2" data-scroll data-scroll-speed="1"
                        data-scroll-direction="diagonal">
                        <img src="{{ URL::asset('img/Linus_feature.png') }}" alt="Exhibit Mockup">
                    </div>

                    <div class="col-md-6 text-left order-sm-2 order-md-1 lh-0 order-lg-1">
                        <h1 class=" display-3 subheader fst-italic" data-scroll data-scroll-speed="2"
                            data-scroll-direction="horizontal">Information <span class="fw-bold fst-normal">At Your</span>
                        </h1>
                        <h1 class="display-3 subheader fst-italic" data-scroll data-scroll-speed="-2"
                            data-scroll-direction="horizontal"><span class="fw-light">Doorstep</span></h1>
