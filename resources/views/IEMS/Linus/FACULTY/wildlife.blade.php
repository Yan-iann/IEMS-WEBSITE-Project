                        ...
                        <div class="container-fluid">
                            <div class="row g-4 m-4 p-0 d-flex align-items-stretch g-l">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="input" class="form-control" placeholder="Enter Critter Name"
                                        name="wildlife_name" required>
                                </div>
                                <div class="col-12">
                                    <label for="formGroupExampleInput" class="form-label">Scientific Name</label>
                                    <input type="input" class="form-control"
                                        placeholder="Enter Critter Scientific Name" name="wildlife_scientific_name"
                                        required>
                                </div>
                                <div class="col-12 col-md-4">
                                    <label for="formGroupExampleInput2" class="form-label">Class</label>
                                    <input type="input" placeholder="Enter Critter Class" class="form-control"
                                        name="wildlife_class" required>
                                </div>
                                <div class="col-12 col-md-4">
                                    <label for="formGroupExampleInput2" class="form-label">Order</label>
                                    <input type="input" class="form-control" placeholder="Enter Critter Order"
                                        name="wildlife_order" required>
                                </div>
                                <div class="col-12 col-md-4">
                                    <label for="formGroupExampleInput2" class="form-label">Family</label>
                                    <input type="input" class="form-control" placeholder="Enter Critter Family"
                                        name="wildlife_family" required>
                                </div>
                                <div class="-12 col-md-4">
                                    <label for="formGroupExampleInput2" class="form-label">Genus</label>
                                    <input type="input" class="form-control" placeholder="Enter Critter Genus"
                                        name="wildlife_genus" name="wildlife_genus" required>
                                </div>
                                <div class="col-12 col-md-4">
                                    <label for="formGroupExampleInput2" class="form-label">Species</label>
                                    <input type="input" class="form-control" placeholder="Enter Critter Species"
                                        name="wildlife_species" required>
                                </div>
                                <div class="col-12">
                                    <label for="formGroupExampleInput2" class="form-label">Location</label>
                                    <input type="input" class="form-control" placeholder="Enter Critter Location"
                                        name="wildlife_location" required>
                                </div>

                                <div class="col-12">
                                    <label for="formGroupExampleInput2" class="form-label">Date Added</label>
                                    <input type="date" class="form-control" placeholder="Enter Date Added"
                            ...
                            <div class="row g-4 m-4 p-0 d-flex align-items-stretch g-l">
                                ...
                                <div class="col-12">
                                    <div class="row d-flex justify-content-between">
                                        ...
                                        <div class="col-6">
                                            <a href="{{ route('sortNameDesc') }}"><i class="fas fa-sort"></i>Desc</a>
                                            <a href="{{ route('sortNameAsc') }}" ><i class="fas fa-sort"></i>Asc</a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="row d-flex justify-content-between">
                                        ...
                                        <div class="col-6">
                                            <a href="{{ route('dateAddedDesc') }}" ><i class="fas fa-sort"></i>Desc</a>
                                            <a href="{{ route('dateAddedAsc') }}" ><i class="fas fa-sort"></i>Asc</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
