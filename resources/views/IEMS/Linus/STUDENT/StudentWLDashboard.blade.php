                            ...
                            <div class="row g-4 m-4 p-0 d-flex align-items-stretch g-l">
                                ...
                                <div class="col-12">
                                    <div class="row d-flex justify-content-between">
                                        ...
                                        <div class="col-6">
                                            <a href="{{ route('sortNameDesc_S') }}"><i class="fas fa-sort"></i>Desc</a>
                                            <a href="{{ route('sortNameAsc_S') }}" ><i class="fas fa-sort"></i>Asc</a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="row d-flex justify-content-between">
                                        ...
                                        <div class="col-6">
                                            <a href="{{ route('dateAddedDesc_S') }}" ><i class="fas fa-sort"></i>Desc</a>
                                            <a href="{{ route('dateAddedAsc_S') }}" ><i class="fas fa-sort"></i>Asc</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
