...
<div data-scroll-section class="home-banner w-100 vh-100 d-flex justify-content-center align-items-center" style="background-image: url('img/Home_Banner.png'); background-size:cover;
    ...
    <div class="content text-center ">
        ...
        <h1 class="display-2 text-white text-wrap lh-1 fst-italic" style="font-family: 'Playfair Display', serif" data-scroll data-scroll-speed="-1.5" data-scroll-direction="horizontal">
            the institute of</h1>
...
<section data-scroll-section class="mbr-section article" style="background-color: #bb1017; padding-top: 18px; padding-bottom:1px; object-fit:cover ">
    <div class="container-fluid">
        <div class="row d-flex align-items-center text-center justify-content-center">
            <p data-scroll data-scroll-speed="-1" data-scroll-direction="horizontal" class="text-white fst-italic fw-light">This is the <span class=" fw-bold">official</span> Silliman
...
<section data-scroll-section class="mbr-section article" style="background-color: #1da2d8; padding-top: 120px; padding-bottom:100px; object-fit:cover ">
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-12 col-md-12 col-lg-4 order-lg-3 text-md-left text-leftorder-lg-3 word-wrap" style="margin-top: 50px; padding-left:50px;padding-right: 50px" data-scroll data-scroll-speed="0.4">
            ...
            <div class="col-12 col-md-12 col-xl-4 order-lg-1 d-none d-lg-block" style="margin-top: 190px">
                <div class="row d-flex justify-content-center align-items-end">
                    ...
                    <div class="col-12 m-15" style="padding-bottom: 50px; transform:translateX(10%)" data-aos="fade-up" data-aos-delay="0">
                        <div class="text text-center" style="padding-left: 40px;padding-right:40px">
                            <div class="row justify-content-center">
                    ...
                    <div class="col-12 m-15" style="padding-bottom: 50px; transform:translateX(20%)" data-aos="fade-up" data-aos-delay="0">
                        <div class="text text-center" style="padding-left: 40px;padding-right:40px">
                            <div class="row justify-content-center">
...
<section data-scroll-section class="mbr-section article" style="background-color: rgb(242, 242, 242); padding-top: 120px; padding-bottom: 120px;">
    <div class="container-fluid g-10">
        <div class="row d-flex justify-content-center align-items-center text-align-left g-10">
            <div class="item col-lg-4 m-20 text-md-center text-lg-center text-sm-center lh-1" style="padding-bottom: 50px">
                <p class="lead m-0 fw-bold" style="padding-bottom: 20px">Announcements</p>
                <h1 class="display-2 subheader fst-italic lh-1" style="color:#1da2d8; font-family: 'Playfair Display', serif; padding-bottom: 20px" data-scroll data-scroll-speed="1.5" data-scroll-direction="horizontal">See What's
                    Happening</h1>
            ...
            <div class="col-12 col-md-6 col-lg-6">
                ...
                <div class="wrapper">
                    ...
                    <div class="item col-md-1 col-lg-1 order-lg-2 my-10 m-0">
                        ...
                        <div class="card bg-dark text-white  align-text-bottom" style="width:36rem; height: 90vh; object-fit:cover;cursor:default">

                            <img src="{{ asset($item->anno_pic) }}" class="card-img-top" style="width:36rem; height: 90vh; object-fit:cover" alt="Announcement">
                            {{-- Photo --}}
                            ...
                            <div class="card-img-overlay d-flex flex-column justify-content-end">
                                ...
                                <p><a class="btn btn-lg btn-light" href="{{ route('accessAnnouncementDisplay', $item->anno_ID) }}">Read
                                        Announcement</a>
                    ...
                    <div class="item col-md-1 col-lg-1 order-lg-2 my-10 m-0">
                        <div class="card align-text-bottom border-dark" style="background:#e5e5e5; width:36rem; height: 90vh; object-fit:cover;cursor:default">
                            <div class="card-img-overlay d-flex flex-column justify-content-end">
...
<section data-scroll-section class="mbr-section article" style="background-color: rgb(242, 242, 242);">
    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            ...
            {{-- Carousel Item 1 --}}
            <div class="carousel-item  active " style="background-image: linear-gradient(0deg, #00000022,  #00000058),url('img/Carousel_IEMS.jpg');
            ...
            {{-- Carousel Item 2 --}}
            <div class="carousel-item" style="background-image: linear-gradient(0deg, #00000022,  #00000022),url('img/Carousel_Facilities.jpg'); background-size:cover;background-repeat: no-repeat; background-blend-mode: multiply;">
                <div class="container">
                    <div class="carousel-caption">
            ...
            {{-- Carousel Item 3 --}}
            <div class="carousel-item" style="background-image: linear-gradient(0deg, #00000034,  #00000034),url('img/Carousel_Faculty.jpg'); background-size:cover;background-repeat: no-repeat; background-blend-mode: multiply; background-position:center; ">
                <div class="container">
                    <div class="carousel-caption">
            ...
            {{-- Carousel Item 4 --}}
            <div class="carousel-item" style="background-image: url('img/Carousel_Linus.jpg'); background-size:cover;background-repeat: no-repeat; background-blend-mode: multiply; background-position:center; ">
                <div class="container">
                    <div class="carousel-caption">
            ...
            {{-- Carousel Item 5 --}}
            <div class="carousel-item" style="background-image: linear-gradient(0deg, #00000034,  #00000034),url('img/Carousel_Rates.jpg'); background-size:cover;background-repeat: no-repeat; background-blend-mode: multiply; background-position:center;">
                <div class="container">
                    <div class="carousel-caption">
            ...
            {{-- Carousel Item 6 --}}
            <div class="carousel-item" style="background-image: linear-gradient(0deg, #00000034,  #00000034),url('img/Carousel_Enrollment.jpg'); background-size:cover;background-repeat: no-repeat; background-blend-mode: multiply; background-position:center; ">
                <div class="container">
                    <div class="carousel-caption">
            ...
            {{-- Carousel Item 7 --}}
            <div class="carousel-item" style="background-image: linear-gradient(0deg, #00000034,  #00000034),url('img/Carousel_Vision.jpg'); background-size:cover;background-repeat: no-repeat; background-blend-mode: multiply; background-position:center; ">
                <div class="container">
                    <div class="carousel-caption">
                        <h1 class="subheader  text-white fst-italic fw-light">Vision & Mission</h1>
                        <p>The goals of what the college strive for</p>
                        <p><a class="btn btn-lg btn-light" href="{{ route('vision') }}">Learn more</a></p>
                    </div>
                </div>
            </div>
                ...
                <div class="custom-accordion" id="accordionPanelsStayOpenExample">
                    <div class="accordion-item">
                        <p id="panelsStayOpen-headingOne">
                            <button class="btn-link" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseOne" aria-expanded="true" aria-controls="panelsStayOpen-collapseOne">
                    ...
                    <div class="accordion-item">
                        <p id="panelsStayOpen-headingTwo">
                            <button class="btn-link collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseTwo" aria-expanded="false" aria-controls="panelsStayOpen-collapseTwo">
                    ...
                    <div class="accordion-item">
                        <p id="panelsStayOpen-headingThree">
                            <button class="btn-link collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseThree" aria-expanded="false" aria-controls="panelsStayOpen-collapseThree">
...
<section data-scroll-section class="mbr-section article  justify-content-center align-items-center text-center" style="background-color: rgb(242, 242, 242); padding-top: 120px; padding-bottom: 120px; min-height:80vh">
    <div class="container-fluid">
        <div class="row">
            <div class="col-3 d-none d-lg-block">
                <div class="image-stack">
                    ...
                    <div class="image-stack__item image-stack__item--top">
                        <img src="{{ URL::asset('img/CTA_lowerleft.jpg') }}" alt="Divers" style="width:500px" data-scroll data-scroll-speed="3.9">
                    </div>
                </div>
            </div>
            ...
            <div class="col-3 d-none d-lg-block">
                <div class="image-stack">
                    <div class="image-stack__item image-stack__item--bottom2" style="transform: translateY(-3rem)" data-scroll data-scroll-speed="-4.0">
                        <img src="{{ URL::asset('img/CTA_upperright.jpg') }}" alt="Crocodile Pen">
                    </div>

                    <div class="image-stack__item image-stack__item--top2" style="transform: translateY(10rem)" data-scroll data-scroll-speed="1.5">
