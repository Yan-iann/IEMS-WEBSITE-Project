...
@section('content')
            ...
            <div class="row  d-flex justify-content-center">
                ...
                <div class="col-6 col-md-2 col-lg-2" style="margin: 20px">
                    <div class="card bg-transparent" style="width: 18rem; border:none; cursor:default">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">Name</h5> {{--Name Of Faculty--}}
                            <p class="card-text">Rank</p>     {{--Rank Of Faculty--}}
    ...
    <div class="modal fade" id="viewfacultydetails" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
                            ...
                            <div class="row g-4 m-4 p-0 d-flex align-items-stretch g-l ">
                                ...
                                <div class=" col-12 d-flex justify-content-between">
                                    ...
                                    <div class="col-12 col-lg-4">
                                        <p class="text-muted">emailoffaculty@su.edu.ph</p> {{-- Email --}}
                                    </div>

                                    <div class="col-12 col-lg-4">
                                        <p class="text-muted">+639654773277</p> {{-- Contact Number --}}
                                    </div>
                                </div>
