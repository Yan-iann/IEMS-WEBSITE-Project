    ...
    <div class="site-footer " style="background-color: #252525">
        <div class="container">
            <div class="row justify-content-between">
                <div class="col-lg-4 ">
                    <a href="https://www.facebook.com/SillimanUniversity/" target="_blank"><img
                            class="img-fluid float-start" src="{{ URL::asset('img/Logo_SU.png') }}" style="width:80px"></a>
                    <a href="/"><img class="img-fluid" src="{{ URL::asset('img/Logo_IEMS.png') }}"
                            style="width:80px"></a>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="widget">
                        ...
                        <ul class="social list-unstyled">
                            <li><a href="https://www.facebook.com/iemsSTEWaRDS/" target="_blank"><i
                                        class='bx bxl-facebook-circle' style="font-size: 40px; padding:4.8px"></i></a>
                            </li>
                            <li><a href="https://www.instagram.com/silliman_u/?hl=en" target="_blank"><i
                                        class='bx bxl-instagram' style="font-size: 40px; padding:4.8px"></i></a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-4">
                        ...
                        <div class="col-6 col-sm-6 col-md-4">
                            <div class="widget">
                                <ul class="links list-unstyled">
                                    ...
                                    <li><a href="/construction" hidden>Fishery</a></li>
