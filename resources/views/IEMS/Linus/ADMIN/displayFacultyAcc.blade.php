...
<body>
  ...
  <div class="row">
    <div class="col">
        <div class="az-content-label mg-b-5"><h3>Faculty Accounts</h3></div>
    </div>
          ...
          <div class="modal-body">
            ...
            <div class="row g-4 m-4 p-0 d-flex align-items-stretch g-l">
                  ...
                  <div class="col-12 col-md-4">
                    ...
                    <input type="input" placeholder="Enter Educational Attaintment" class="form-control" name="educational" >
                  </div>

                  <div class="col-12 col-md-4">
                    <label for="formGroupExampleInput" class="form-label">Rank</label>
                    <input type="input" placeholder="Enter Rank" class="form-control" name="rank" >
                  </div>

                  <div class="col-12 col-md-4">
                    <label for="formGroupExampleInput" class="form-label">specialty</label>
                    <input type="input" placeholder="Enter Specialty" class="form-control" name="specialty" >
                  </div>

                  <div class="col-12 col-md-4">
                    <label for="formGroupExampleInput" class="form-label">Phone Number</label>
                    <input type="input" placeholder="Enter Phone Number" class="form-control" name="phone_no" >
                  </div>

                <input type="hidden" class="form-control"  placeholder="Enter user type " name="user_type" value="Faculty">
