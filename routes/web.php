...
Route::prefix('IEMSFaculty')->middleware('auth', 'isFaculty')->group(function () {
    ...
    //for bone//
    Route::get('/b_sortNameD', [infocardMaintain::class, 'sortNameDescB'])->name('sortNameDescB');
    Route::get('/b_sortNameA', [infocardMaintain::class, 'sortNameAscB'])->name('sortNameAscB');
    Route::get('/b_sortDateD', [infocardMaintain::class, 'dateAddedDescB'])->name('dateAddedDescB');
    Route::get('/b_sortDateA', [infocardMaintain::class, 'dateAddedAscB'])->name('dateAddedAscB');
    //end for bone

    //for ref
    Route::get('/r_sortNameD', [infocardMaintain::class, 'sortNameDescR'])->name('sortNameDescR');
    Route::get('/r_sortNameA', [infocardMaintain::class, 'sortNameAscR'])->name('sortNameAscR');
    Route::get('/r_sortDateD', [infocardMaintain::class, 'dateAddedDescR'])->name('dateAddedDescR');
    Route::get('/r_sortDateA', [infocardMaintain::class, 'dateAddedAscR'])->name('dateAddedAscR');
    //end for ref
...
Route::prefix('IEMSStudent')->middleware('auth', 'isStudent')->group(function () {
    ...
    //for bone//
    Route::get('/b_sortNameD_S', [studentController::class, 'sortNameDescB_S'])->name('sortNameDescB_S');
    Route::get('/b_sortNameA_S', [studentController::class, 'sortNameAscB_S'])->name('sortNameAscB_S');
    Route::get('/b_sortDateD_S', [studentController::class, 'dateAddedDescB_S'])->name('dateAddedDescB_S');
    Route::get('/b_sortDateA_S', [studentController::class, 'dateAddedAscB_S'])->name('dateAddedAscB_S');
    //

    //for reference
    Route::get('/r_sortNameD_S', [studentController::class, 'sortNameDescR_S'])->name('sortNameDescR_S');
    Route::get('/r_sortNameA_S', [studentController::class, 'sortNameAscR_S'])->name('sortNameAscR_S');
    Route::get('/r_sortDateD_S', [studentController::class, 'dateAddedDescR_S'])->name('dateAddedDescR_S');
    Route::get('/r_sortDateA_S', [studentController::class, 'dateAddedAscR_S'])->name('dateAddedAscR_S');
    //
...
//for bone//
Route::get('/b_sortNameD_G', [guestController::class, 'sortNameDescB_G'])->name('sortNameDescB_G');
Route::get('/b_sortNameA_G', [guestController::class, 'sortNameAscB_G'])->name('sortNameAscB_G');
Route::get('/b_sortDateD_G', [guestController::class, 'dateAddedDescB_G'])->name('dateAddedDescB_G');
Route::get('/b_sortDateA_G', [guestController::class, 'dateAddedAscB_G'])->name('dateAddedAscB_G');
//

//for reference
Route::get('/r_sortNameD_G', [guestController::class, 'sortNameDescR_G'])->name('sortNameDescR_G');
Route::get('/r_sortNameA_G', [guestController::class, 'sortNameAscR_G'])->name('sortNameAscR_G');
Route::get('/r_sortDateD_G', [guestController::class, 'dateAddedDescR_G'])->name('dateAddedDescR_G');
Route::get('/r_sortDateA_G', [guestController::class, 'dateAddedAscR_G'])->name('dateAddedAscR_G');
//
...
Route::get('/vision', [IEMSWebsite::class, 'accessVision'])->name('vision');
