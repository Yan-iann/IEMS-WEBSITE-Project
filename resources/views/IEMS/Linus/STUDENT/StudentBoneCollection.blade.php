        ...
        <div class="col-12 col-md-6 col-lg-6 order-sm-2 order-md-1">
            <div class="home-content">
                <div class="col-12 col-md-6 col-lg-6 d-flex align-items-center">
                    ...
                    <span class="text">Whale Bone</span>
                </div>
            </div>
        </div>

        <div class="col-12 col-md-6 col-lg-6 order-sm-1 order-md-2">
            <form style="text-align: center;" class="form-inline my-2 my-lg=0" type="get" action="{{ route('S_searchBone') }}">
                <div class="input-group">
                    <input type="search" name="searchBone" class="form-control mr-sm2" placeholder="SearchBone Collection Common Name">
...
<section class="col-12">
    <div class="container-fluid">
        <div class="row g-5 m-4 p-0 d-flex align-items-stretch">
            ...
            @include('IEMS.Linus.STUDENT.displayBoneCollection')
            @endforeach
        </div>
        <!--end of catalog-->
...
<!--advance search-->
<form action="{{ route('S_advanceSearchBone') }}" method="GET" enctype="multipart/form-data">
    {!! csrf_field() !!}
